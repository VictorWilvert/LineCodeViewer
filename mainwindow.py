...
class MainWindow(QMainWindow, Ui_MainWindow):
  ...
  CODELINE_INFO_DICT = {
    ...
    'MLT-3': (("Bit 1", "Bit 0 Crescendo", "Bit 0 Decrescendo", "Bit -1"), (-1, 1))
  }
  ...
  def update(self):
    ...
    self._diagram_vector[self._diagram_index].setInitialCondition(
    ...
    if self._digrama_update is True:
        ...
        self.canvas[self._diagram_index] = FigureCanvas(self._diagram_vector[self._diagram_index].figure())
  ...
  def readInput(self):
    ...
    if text is None:
      ...
      self._request_update = True
      return None
    elif self.radioButtonBinary.isChecked():
      data_bin = text
      if len(data_bin) > 2:
  ...
  def initConnections(self):
    ...
    self.comboBox.currentIndexChanged.connect(self.requestUpdate)
